...
import com.example.shuaijia.xzcalendarview.tableLayout.listener.CustomTabEntity;
import com.example.shuaijia.xzcalendarview.tableLayout.listener.OnTabSelectListener;
import com.example.shuaijia.xzcalendarview.tableLayout.utils.FragmentChangeManager;
...
//        Logger.d("AAA", "mLastP--->" + mLastP.left + "&" + mLastP.right);
//        Logger.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
