...
import com.example.shuaijia.xzcalendarview.tableLayout.listener.OnTabSelectListener;
import com.example.shuaijia.xzcalendarview.tableLayout.utils.UnreadMsgUtils;
import com.example.shuaijia.xzcalendarview.tableLayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private Typeface fromAsset;//字体样式
    /**
     * 用于绘制显示器
     */
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        if (tv_tab_title != null) {
            if (title != null) {
                if (fromAsset != null) {
                    tv_tab_title.setTypeface(fromAsset);
                    SpannableString spannableString = new SpannableString(title);
                    spannableString.setSpan(new AbsoluteSizeSpan(15, true), title.length() - 1, title.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setTabWidthEqualSize(int equalSize) {
        this.mTabWidth = this.mContext.getResources().getDisplayMetrics().widthPixels / equalSize;
        updateTabStyles();
    }
    ...
    public void setTextTypeface(Typeface fromAsset) {
